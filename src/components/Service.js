...
<div class="row wsr">
            <div class="col-lg-12">
              ...
              <select class="form-select form-control" id="jobs" required>
...
<div class="row wsr">
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control-file" id="exampleFormControlFile1"style={{paddingLeft:"16px"}}/>
...
<div class="form-check">
            ...
            <div className="appb">
            <button class="w-25 btn apbu " type="submit" >Send</button>
         </div>
